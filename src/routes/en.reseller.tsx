...
const FAQ = [
  { q: "What is an IPTV reseller program?", a: "An IPTV reseller program lets you buy IPTV subscriptions at wholesale price from a provider like Nexora IPTV, then resell them to your own clients at retail price. You keep the margin and manage your customers from a dedicated reseller panel." },
  { q: "How does the Nexora IPTV reseller panel work?", a: "After approval you receive access to a web-based reseller panel where you can create new IPTV lines, renew or suspend existing ones, generate M3U links or Xtream Codes credentials, set trial durations and monitor active clients — all in real time." },
  { q: "How much does it cost to become an IPTV reseller?", a: "Nexora IPTV reseller credits start at €90 for 10 credits (€9 per line) and scale down to €5 per line on the Elite 250-credit pack. There is no monthly fee — you only pay for the credits you use, and unused credits never expire." },
  { q: "How much can I earn as an IPTV reseller?", a: "Retail prices for a 12-month IPTV subscription typically range from €60 to €120. With a wholesale cost of €5–€9 per credit (1 month), most active resellers earn a 40–70% margin per client after marketing costs." },
  { q: "Do I need technical skills to start?", a: "No. The reseller panel is designed for non-technical users — creating a line takes under 30 seconds. Our team also provides onboarding, ready-made marketing assets and 24/7 priority support to help you launch quickly." },
  { q: "Can I white-label the service under my own brand?", a: "Yes. You deliver the credentials under your own brand, price and communication channels. Nexora IPTV operates as your silent wholesale supplier — your clients only see you." },
];

export const Route = createFileRoute("/en/reseller")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://nexora-iptv.com/en/reseller" },
    ...
    links: [
      { rel: "canonical", href: "https://nexora-iptv.com/en/reseller" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          offers: { "@type": "AggregateOffer", priceCurrency: "EUR", lowPrice: "90", highPrice: "1250", offerCount: 5 },
        }),
      },
      {
        type: "application/ld+json",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "IPTV Reseller Program", item: "https://nexora-iptv.com/en/reseller" },
          ],
        }),
      },
    ],
      ...
      <main className="pt-28 pb-24">
        <section className="max-w-4xl mx-auto px-6 text-center mb-16">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <Link to="/en" className="px-6 py-3 rounded-lg border border-white/15 hover:bg-white/5 transition">Back to home</Link>
          </div>
        </section>
