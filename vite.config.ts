...
const APP_STORE_MODE =
  process.env.VITE_APP_STORE_MODE === "1" || process.env.VITE_APP_STORE_MODE === "true";

const pwaPlugin = APP_STORE_MODE
  ? null
  : VitePWA({
...
export default defineConfig({
  ...
  vite: {
    plugins: [mcpPlugin(), pwaPlugin].filter(Boolean),
  },
});
